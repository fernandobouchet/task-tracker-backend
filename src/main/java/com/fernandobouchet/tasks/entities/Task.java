...
public class Task {
    ...
    public Task(UUID id, String title, String description, LocalDateTime dueDate, TaskPriority priority, TaskStatus status, LocalDateTime updated, LocalDateTime created) {
        this.id = id;
        this.title = title;
